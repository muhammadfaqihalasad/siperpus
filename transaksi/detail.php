			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="text-left" colspan="2">
						...
						<a class="btn btn-dark" <?php if($detail['tgl_kembali']!=NULL){echo "disabled";}?> href="kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>"> Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
